...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/../.symlinks/plugins/jl_ota/ios/Frameworks/JLLogHelper.framework"
  install_framework "${PODS_ROOT}/../.symlinks/plugins/jl_ota/ios/Frameworks/JL_AdvParse.framework"
  install_framework "${PODS_ROOT}/../.symlinks/plugins/jl_ota/ios/Frameworks/JL_BLEKit.framework"
  install_framework "${PODS_ROOT}/../.symlinks/plugins/jl_ota/ios/Frameworks/JL_HashPair.framework"
  install_framework "${PODS_ROOT}/../.symlinks/plugins/jl_ota/ios/Frameworks/JL_OTALib.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/jl_ota/jl_ota.framework"
